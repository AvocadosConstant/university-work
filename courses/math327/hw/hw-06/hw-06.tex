...
\begin{homeworkProblem}[22]
    ...
    \textbf{Solution} 
    \[ P(X>10) = 1-P(X\leq10) = 1-\frac{10}{30-0} = \frac{2}{3} \] \\
    ...
    \textbf{Solution} 
    \[ P(X\geq25|X\geq15) = \frac{P(X\geq25\cap X\geq15)}{P(X\geq15)} = \frac{\frac{5}{30}}{\frac{15}{30}} = \frac{1}{3} \] \\
...
\begin{homeworkProblem}[26]
    ...
    \begin{enumerate}[label=(\alph*)]
        ...
        \item what is the probability that the total of the demands in the next 2 weeks exceeds 2,200?
            ...
            $P(D_1 + D_2 > 2000) = P(\frac{D_1+D_2-2000}{\sigma} > \frac{2200-2000}{\sigma}) = 1-.76... = .24...$
    \end{enumerate}
\end{homeworkProblem}
...
\begin{homeworkProblem}[44]
    ...
    \textbf{Solution}
    \begin{verbatim}
    ans = rchisq(10^7, df = 3) + rchisq(10^7, df=6)
    length(ans[ans > 10]) / length(ans)
...
\begin{homeworkProblem}[1]
    If $X\sim N(\mu, \sigma^c)$

    \begin{enumerate}
        \item Find $P[\mu - 1.51 \sigma < X \leq \mu + 1.51\sigma]$

            $\phi(1.51)-\phi(-1.51) = 2\phi(1.51)-1$

        \item Find c

            $P[\mu - c\sigma < X \leq \mu + c\sigma] = .90$

            $2\phi(c)-1 = .90 \rightarrow c=\phi^{-1}(.85)$
    \end{enumerate}
\end{homeworkProblem}

\begin{homeworkProblem}
    $\chi \sim \chi^2_1$ (use A1 Normal Table) $P[X < 0.7809] = ?$
