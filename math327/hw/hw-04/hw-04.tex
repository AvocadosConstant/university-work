...
\begin{homeworkProblem}
    ...
    \begin{align*}
        E[X_1X_2] &= \int \int xy f_{X_1, X_2}(x, y) \,dx \,dy\\
                  &= \int_0^1 \int_0^{y-1} (xy) 3(x+y) \,dx \,dy\\
                  &= 3 \int_0^1 y \int_0^{y-1} x^2 + xy \,dx \,dy\\
                  &= 3 \int_0^1 y \left(\frac{x^3}{3} + \frac{x^2y}{2} \Big|_0^{y-1}\right) \,dy\\
                  &= 3 \int_0^1 y \left(
                      \left(\frac{(y-1)^3}{3} + \frac{(y-1)^2y}{2} \right) - 
                  ...
                  \right) \Big|_0^1\\
                  &= \frac{1}{2} \left(
                       1^5 -3\cdot1^4 +3\cdot1^3 -1^2
                  \right)
                  - \left(
                       0^5 -3\cdot0^4 +3\cdot0^3 -0^2
                  \right)\\
                  &= \frac{1}{2} \left(
                       1 -3 +3 -1
                   \right)\\
        E[X_1X_2] &= 0
    \end{align*}
\begin{center}\LARGE{IS IT ACTUALLY 0? WHY DID I DO ALL THIS WORK?!}\end{center}

    Now we will solve for the correlation.
    \begin{align*}
        Corr(X_1, X_2) &= \frac{E[X_1X_2] - E[X_1]E[X_2]}{\sqrt{Var(X_1)}\sqrt{Var(X_2)}}\\
                       &= \frac{0 - \frac{3}{8}\frac{3}{8}}{\sqrt{\frac{19}{320}}\sqrt{\frac{19}{320}}}\\
                       &= \frac{(\frac{9}{64})}{(\frac{19}{320})}\\
        Corr(X_1, X_2) &= \frac{45}{19}
    \end{align*}
